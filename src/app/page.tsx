...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/close-up-portrait-fashionable-bearded-businessman-with-stylish-haircut-speaking-by-phone-drinks-glass-cool-juice-sitting-cafe-outdoors_613910-6697.jpg",
          alt: "barber client portrait clean",
        },
        {
        ...
        {
          src: "http://img.b2bpic.net/free-photo/man-getting-his-beard-trimmed_23-2148256924.jpg",
          alt: "barber client portrait clean",
        },
        {
          src: "http://img.b2bpic.net/free-photo/two-businessmen-talking-phone-city_1153-8203.jpg",
          alt: "Two businessmen talking on the phone in the city",
        },
      ]}
      ...
      marqueeItems={[
        {
          type: "text",
          text: "Traditionelle Handwerkskunst",
        },
        {
          type: "text",
          text: "Modernes Ambiente",
        },
        {
          type: "text",
          text: "Präzise Haarschnitte",
        },
        {
          type: "text",
          text: "Professionelle Bartpflege",
        },
        {
          type: "text",
      ...
      plans={[
        {
          ...
          badge: "Basis",
          price: "25€",
          subtitle: "Klassischer Herrenhaarschnitt",
          buttons: [
            {
              text: "Buchen",
              href: "#booking",
        ...
        },
        {
          ...
          badge: "Premium",
          price: "35€",
          subtitle: "Skin Fade mit Übergang",
          buttons: [
            {
              text: "Buchen",
              href: "#booking",
